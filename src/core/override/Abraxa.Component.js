Ext.define('Abraxa.Component', {
    ...
    initialize: function (me) {
        ...
        // let lastChild = this.el.getLastChild();
        // if (lastChild) {
        //     // if (this.testId) console.log(this.testId, lastChild);
    ...
    applyObjectPermission: function (permissions) {
        ...
        // console.log(slug.toLowerCase().includes(permissions[slug]));
        ...
        if (slug && permissions) {
            if (permissions[slug]) {
                ...
                if (!action.edit && this.getXTypes().indexOf('tab') == -1) {
                    ...
                    // return;
                    //This is bug.Hide components if view users have only view permissions
                    //Added for sharing permissions to hide tabs.
                    //  else {
                    //     this.setBind({
                    //         hidden: null
                    //     });
                ...
                // if (this.skipEditPermission && !action.delete && (this.getXTypes().indexOf('button') > -1 || this.getXTypes().indexOf('menuitem') > -1)) {
                //     this.setDisabled(true);
                // }
                if (
