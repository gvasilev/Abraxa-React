                        ...
                        handler: function (me) {
                            ...
                            Ext.create('Ext.Dialog', {
                                ...
                                buttons: [
                                    {
                                        text: 'Cancel',
                                        testId: 'vouchersDialogRenameCancelButton',
                                        margin: '0 8 0 0',
                                        handler: function () {
                                            record.reject();
                                            this.up('dialog').destroy();
                                    ...
                                    {
                                        text: 'Save',
                                        testId: 'vouchersDialogRenameSaveButton',
                                        ui: 'action',
                                        handler: function () {
                                            if (record.dirty) {
    ...
    lbar: {
        ...
        items: [
            ...
            },
            {
                ...
                bind: {
                    // This vouchers store is defined in PorcallMainViewModel
                    store: '{vouchers}',
                },
                listeners: {
                    painted: function (me) {
                ...
                items: [
                    {
                        ...
                        accept: '.pdf',
                        text: 'Upload',
                        testId: 'vouchersDialogUploadButton',
