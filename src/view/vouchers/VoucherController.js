Ext.define('Abraxa.view.vouchers.VoucherController', {
    ...
    init: function () {
        // if (WebViewer.getInstance()) {
        //     WebViewer.getInstance().dispose();
        // }
    },
    loadViewer: function () {
        let me = this,
        ...
        WebViewer.default(
            ...
            // annotationManager.on('annotationChanged', (annotations, action, e) => {
    ...
    upload: function (files, el, record) {
        ...
        // }
        // if (errorFile) {
        //     Ext.Msg.error('<span class="hbox"><i class="md-icon-outlined mr-8">info</i>Information</span>', 'Only PDF format allowed!');
        //     return false;
        // }
        for (var i = 0; i < files.length; i++) {
