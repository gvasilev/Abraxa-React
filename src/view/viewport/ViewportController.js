Ext.define('Abraxa.view.viewport.ViewportController', {
        ...
        return new Ext.Promise(function (resolve, reject) {
            me.checkLogin().then(function (content) {
                if (content.success == false && content.message == 'User not found') {
                    ...
                    reject(content.message || 'Login failed');
                }
                if (content.data) {
                    let user = Ext.Viewport.getViewModel().get('currentUser');
                    let company = Abraxa.getApplication()
    ...
    initAfterLogin: function () {
        // The code to initialize the application after a successful login goes here
        console.log('User is logged in, proceeding with application initialization');
        // return (
        //     <div
        //         style={{
        ...
        //     </div>
        // );
        // You can initialize your main view, set up routes, etc.
    },
});
