Ext.define(
    'Abraxa.view.calculator.portcostengine.portsettings.show.pricebooks.show.services.show.datafields.show.ChoiceForm',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.portsettings.show.pricebooks.show.services.show.datafields.show.choiceform',
        flex: 1,
        scrollable: true,
        height: '100%',
        layout: {
                                ...
                                items: [
                                    {
                                        xtype: 'selectfield',
                                        forceSelection: false,
                                        reference: 'pbs_optionsSourceEdit',
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        handler: function (me) {
                            ...
                            let selectionPort = me.upVM().get('calculatorPortSettingsGrid.selection');
                            let form = Ext.ComponentQuery.query('container[reference=pbs_choiceForm]')[0].down(
                                'formpanel'
                            );
                            let store = record.store;
                            ...
                            if (record.dirty) {
                                store.sync({
                                    success: function () {
                                        ...
                                        Ext.ComponentQuery.query('container[reference=pbs_choiceForm]')[0]
                                            .down('form\\.error')
                                            .hide()
                                            .removeCls('error');
                                        Abraxa.utils.Functions.updatePortCost(selectionPort);
