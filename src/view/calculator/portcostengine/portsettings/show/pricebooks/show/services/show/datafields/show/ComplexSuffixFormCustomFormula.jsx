Ext.define(
    'Abraxa.view.calculator.portcostengine.pricebooks.show.services.show.datafields.show.ComplexSuffixFormCustomFormula',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.pricebooks.show.services.show.datafields.show.complexsuffixformcustomformula',
        viewModel: {
                ...
                columns: [
                    {
                        ...
                        flex: 1,
                        bind: {
                            editor: '{pbs_suffix_optionsSourceEdit.selection.value === "formula" ? "textfield" : false}',
                        },
                        editor: '',
                        sortable: false,
                        menuDisabled: true,
                    ...
                    },
                    {
                        ...
                        draggable: false,
                        bind: {
                            hidden: '{pbs_suffix_optionsSourceEdit.selection.value === "formula" ? false : true}',
                        },
                        cell: {
                            cls: '',
                            align: 'right',
