Ext.define(
    'Abraxa.view.calculator.portcostengine.pricebooks.show.services.show.datafields.show.ComplexSuffixFormNomenclature',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.pricebooks.show.services.show.datafields.show.complexsuffixformnomenclature',
        viewModel: {
        ...
        items: [
            {
                xtype: 'selectfield',
                reference: 'pbs_suffix_nomenclatureValueEdit',
                label: 'Usage',
                labelAlign: 'left',
                placeholder: 'Usage',
                required: true,
