Ext.define(
    'Abraxa.view.calculator.portcostengine.pricebooks.show.services.show.datafields.show.ComplexPrefixFormTariffTable',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.pricebooks.show.services.show.datafields.show.complexprefixformtarifftable',
        viewModel: {
        ...
        items: [
            {
                xtype: 'selectfield',
                reference: 'pbs_prefix_tableEdit',
                label: 'Table',
                labelAlign: 'left',
                placeholder: 'Table',
                required: true,
            ...
            },
            {
                ...
                labelAlign: 'left',
                placeholder: 'Axis',
                reference: 'pbs_prefix_tableAxisEdit',
                required: true,
                ui: 'classic',
                cls: 'a-field-icon icon-short icon-rounded',
                bind: {
