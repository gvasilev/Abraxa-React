Ext.define(
    'Abraxa.view.calculator.portcostengine.pricebooks.show.services.show.datafields.show.ChoiceFormCustomFormula',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.pricebooks.show.services.show.datafields.show.choiceformcustomformula',
        viewModel: {
                        ...
                        columns: [
                            {
                                ...
                                flex: 1,
                                bind: {
                                    editor: '{pbs_optionsSourceEdit.selection.value === "formula" ? "textfield" : false}',
                                },
                                editor: '',
                                sortable: false,
                                menuDisabled: true,
                            ...
                            },
                            {
                                ...
                                draggable: false,
                                bind: {
                                    hidden: '{pbs_optionsSourceEdit.selection.value === "formula" ? false : true}',
                                },
                                cell: {
                                    cls: '',
                                    align: 'right',
