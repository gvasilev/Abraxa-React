Ext.define(
    'Abraxa.view.calculator.portcostengine.portsettings.show.pricebooks.show.services.show.datafields.show.NumberForm',
    {
        extend: 'Ext.Container',
        xtype: 'calculator.portcostengine.portsettings.show.pricebooks.show.services.show.datafields.show.numberform',
        flex: 1,
        scrollable: true,
        height: '100%',
        layout: {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        handler: function (me) {
                            ...
                            let form = Ext.ComponentQuery.query('container[reference=pbs_numberForm]')[0].down(
                                'formpanel'
                            );
                            let store = record.store;
                            let selectionPort = me.upVM().get('calculatorPortSettingsGrid.selection');
                            ...
                            if (record.dirty) {
                                store.sync({
                                    success: function () {
                                        ...
                                        Ext.ComponentQuery.query('container[reference=pbs_numberForm]')[0]
                                            .down('form\\.error')
                                            .hide()
                                            .removeCls('error');
                                        Abraxa.utils.Functions.updatePortCost(selectionPort);
