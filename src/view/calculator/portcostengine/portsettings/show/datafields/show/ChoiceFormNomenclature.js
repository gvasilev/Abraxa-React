Ext.define('Abraxa.view.calculator.portcostengine.portsettings.show.datafields.show.ChoiceFormNomenclature', {
    ...
    items: [
        {
            ...
            items: [
                {
                    xtype: 'selectfield',
                    reference: 'nomenclatureValueEdit',
                    label: 'Usage',
                    labelAlign: 'left',
                    placeholder: 'Usage',
                    required: true,
                    ...
                    columns: [
                        {
                            ...
                            flex: 1,
                            bind: {
                                editor: '{optionsSourceEdit.selection.value === "manual" ? "textfield" : false}',
                            },
                            editor: '',
                            sortable: false,
                            menuDisabled: true,
                        ...
                        },
                        {
                            ...
                            draggable: false,
                            bind: {
                                hidden: '{optionsSourceEdit.selection.value === "manual" ? false : true}',
                            },
                            cell: {
                                cls: '',
                                align: 'right',
