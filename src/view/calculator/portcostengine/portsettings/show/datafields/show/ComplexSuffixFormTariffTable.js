Ext.define('Abraxa.view.calculator.portcostengine.portsettings.show.datafields.show.ComplexSuffixFormTariffTable', {
    extend: 'Ext.Container',
    xtype: 'calculator.portcostengine.portsettings.show.datafields.show.complexsuffixformtarifftable',
    viewModel: {
    ...
    items: [
        {
            ...
            bind: {
                ...
                hidden: '{suffix_optionsSourceEdit.selection.value === "tariff_table" ? false : true}',
            },
        },
        {
            xtype: 'selectfield',
            ...
            labelAlign: 'left',
            placeholder: 'Axis',
            reference: 'suffix_tableAxisEdit',
            required: true,
            ui: 'classic',
            cls: 'a-field-icon icon-short icon-rounded',
            bind: {
