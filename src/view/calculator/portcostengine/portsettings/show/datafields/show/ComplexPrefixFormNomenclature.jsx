Ext.define('Abraxa.view.calculator.portcostengine.portsettings.show.datafields.show.ComplexPrefixFormNomenclature', {
    extend: 'Ext.Container',
    xtype: 'calculator.portcostengine.portsettings.show.datafields.show.complexprefixformnomenclature',
    viewModel: {
    ...
    items: [
        {
            xtype: 'selectfield',
            reference: 'prefix_nomenclatureValueEdit',
            label: 'Usage',
            labelAlign: 'left',
            placeholder: 'Usage',
            required: true,
