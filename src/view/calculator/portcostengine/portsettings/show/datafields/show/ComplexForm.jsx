Ext.define('Abraxa.view.calculator.portcostengine.portsettings.show.datafields.show.ComplexForm', {
    extend: 'Ext.Container',
    xtype: 'calculator.portcostengine.portsettings.show.datafields.show.complexform',
    flex: 1,
    scrollable: true,
    height: '100%',
    layout: {
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            cls: 'a-container-field',
                            bind: {
                                hidden: '{prefix_controlEdit.selection.value === "number" ? false : true}',
                            },
                            items: [
                                /*{
                                    xtype: 'container',
                        ...
                        },
                        {
                            ...
                            cls: 'a-container-field',
                            bind: {
                                hidden: '{prefix_controlEdit.selection.value === "choice" ? false : true}',
                            },
                            items: [
                                {
                                    xtype: 'selectfield',
                                    forceSelection: false,
                                    reference: 'prefix_optionsSourceEdit',
                                    ...
                                    bind: {
                                        ...
                                        required: '{prefix_controlEdit.selection.value === "choice" ? true : false}',
                                    },
                                },
                                {
                                    xtype: 'container',
                        ...
                        },
                        {
                            ...
                            cls: 'a-container-field',
                            bind: {
                                hidden: '{suffix_controlEdit.selection.value === "number" ? false : true}',
                            },
                            items: [
                                /*{
                                    xtype: 'container',
                        ...
                        },
                        {
                            ...
                            cls: 'a-container-field',
                            bind: {
                                hidden: '{suffix_controlEdit.selection.value === "choice" ? false : true}',
                            },
                            items: [
                                {
                                    xtype: 'selectfield',
                                    forceSelection: false,
                                    reference: 'suffix_optionsSourceEdit',
                                    label: 'Options source',
                                    labelAlign: 'left',
                                    placeholder: 'Options source',
                                    ui: 'classic',
                                    ...
                                    bind: {
                                        ...
                                        required: '{suffix_controlEdit.selection.value === "choice" ? true : false}',
                                    },
                                },
                                {
                                    xtype: 'container',
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function (me) {
                        ...
                        let form = Ext.ComponentQuery.query('container[reference=complexForm]')[0].down('formpanel');
                        let store = me.upVM().getParent().getStore('calcdatafield');
