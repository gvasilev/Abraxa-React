...
Ext.define('Abraxa.view.portcalls.PortcallsGridActive', {
    ...
    columns: [
        ...
        },
        {
            ...
            grouper: {
                groupFn: function (record) {
                    if (record) return record.get('status_data').sort_order;
                },
            },
            groupHeaderTpl:
    ...
    listeners: {
        ...
        //         });
        //
        //         grid.setGridFilters(data);
        //     });
        //     // Ext.util.Observable.capture(grid, function (evname) {
        //
        //     // });
        // },
        // childtouchstart: function (grid, e) {
