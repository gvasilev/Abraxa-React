import './templates/MainContainer.jsx';
import './AutomationContainer.jsx';
Ext.define('Abraxa.view.settings.automation.AutomationMain', {
    extend: 'Ext.Container',
    xtype: 'settings.automation.main',
    layout: 'vbox',
    flex: 1,
    itemId: 'automationMainContainer',
    scrollable: true,
    showAnimation: {
        type: 'slide',
        direction: 'right',
    ...
    items: [
        ...
        },
        {
            ...
            items: [
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            text: 'SOF',
                                            testId: 'sofTabSettingsTestId',
                                            type: 'sof',
                                        },
                                        {
                                            text: 'Disbursements',
                                            testId: 'disbursementsTabSettingsTestId',
                                            type: 'disbursement',
                                        },
                                    ],
                                },
                ...
                {
                    xtype: 'settings.automation.container',
                },
            ],
        },
    ],
