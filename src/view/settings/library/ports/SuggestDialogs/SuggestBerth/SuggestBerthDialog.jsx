                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            cls: 'a-header-info-item',
                            bind: {
                                html: '<div class="a-header-info-title sm-title">Terminal</div><div class="a-header-info-value">{selectedPort.terminal_name ? selectedPort.terminal_name : "<span class=\'a-cell-placeholder\'>---</span>" }</div>',
                            },
                        },
                        {
                            xtype: 'div',
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                xtype: 'button',
                                enableToggle: true,
                                ui: 'action loading berthSubmission',
