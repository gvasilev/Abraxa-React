...
Ext.define('Abraxa.view.inquiry.appoint.CreateAppointment', {
    ...
    testId: 'inquiryCreateAppointment',
    ...
    tools: {
        back: {
            ...
            margin: 0,
            ui: 'tool round',
            testId: 'inquiryCreateAppointmentBackTool',
            hidden: true,
            left: 16,
            bind: {
        ...
        close: {
            testId: 'inquiryCreateAppointmentCloseTool',
            tooltip: {
                showOnTap: true,
                html: 'Close',
                align: 'bc-tc?',
        ...
        showVoyageInstructions: {
            ...
            testId: 'inquiryCreateAppointmentShowVoyageInstructionsButton',
            bind: {
                hidden: '{editMode}',
        ...
        attach: {
            ...
            testId: 'inquiryCreateAppointmentAttachButton',
            bind: {
                permission: '{userPermissions}',
            },
        ...
        showTemplates: {
            ...
            testId: 'inquiryCreateAppointmentShowTemplatesButton',
            bind: {
    ...
    items: [
        {
            xtype: 'form.error',
            testId: 'inquiryCreateAppointmentFormError',
            hidden: true,
            margin: 0,
            padding: 8,
            docked: 'top',
            ...
            items: [
                {
                    ...
                    testId: 'inquiryCreatePortcallAgentForm',
                                    ...
                                    items: [
                                        {
                                            ...
                                            itemId: 'vesselCombo',
                                            testId: 'inquiryCreateAppointmentVesselCombo',
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                    ...
                                                    items: [
                                                        {
                                                            xtype: 'textfield',
                                                            label: 'File ID',
                                                            testId: 'inquiryCreateAppointmentFileIdField',
                                                            labelAlign: 'left',
                                                ...
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            flex: 1,
                                                            label: 'Assign to',
                                                            testId: 'inquiryCreateAppointmentAssignToField',
                                                ...
                                                },
                                                {
                                                    ...
                                                    label: 'ETA',
                                                    testId: 'inquiryCreateAppointmentEtaField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                ...
                                                },
                                                {
                                                    xtype: 'port.combo',
                                                    label: 'Port',
                                                    testId: 'inquiryCreateAppointmentPortField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                ...
                                                },
                                                {
                                                    ...
                                                    label: 'Port name',
                                                    testId: 'inquiryCreateAppointmentPortNameField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-port icon-rounded',
                                                    required: false,
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    testId: 'inquiryCreateAppointmentAppointingPartyField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                ...
                                                },
                                                {
                                                    ...
                                                    testId: 'inquiryCreateAppointmentVoyageNumberField',
                                                    bind: {
                                                ...
                                                },
                                                {
                                                    ...
                                                    testId: 'inquiryCreateAppointmentNominatingPartyField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-business-center icon-rounded',
                                                    placeholder: 'Choose Company',
                                                ...
                                                },
                                                {
                                                    ...
                                                    testId: 'inquiryCreateAppointmentNominationReferenceField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-short icon-rounded',
                                                    clearable: false,
                                                ...
                                                },
                                                {
                                                    xtype: 'abraxa.datetimefield',
                                                    label: 'Date received',
                                                    testId: 'inquiryCreateAppointmentDateReceivedField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-time icon-rounded',
                                                ...
                                                },
                                                {
                                                    xtype: 'selectfield',
                                                    label: 'Port function',
                                                    testId: 'inquiryCreateAppointmentPortFunctionField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-short icon-rounded',
                                                    required: true,
                                                ...
                                                },
                                                {
                                                    xtype: 'selectfield',
                                                    label: 'Agency type',
                                                    testId: 'inquiryCreateAppointmentAgencyTypeField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-short icon-rounded',
                                                    ...
                                                    items: [
                                                        {
                                                            xtype: 'selectfield',
                                                            label: 'My role',
                                                            testId: 'inquiryCreateAppointmentMyRoleField',
                                                            labelAlign: 'left',
                                                            ui: 'classic hovered-border',
                                                            cls: 'a-field-icon icon-short icon-rounded',
                                                            autoFocus: false,
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            labelAlign: 'right',
                                                            label: 'Sub agent',
                                                            testId: 'inquiryCreateAppointmentSubAgentCheckbox',
                                                            labelCls: 'ml-8',
                                                            labelWidth: 78,
                                                            labelMinWidth: 78,
                                                            slug: 'portcallNominationAgencyStructure',
                                                ...
                                                },
                                                {
                                                    xtype: 'organization.combo',
                                                    label: 'Lead agent',
                                                    testId: 'inquiryCreateAppointmentLeadAgentField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-business-center icon-rounded',
                                                    placeholder: 'Choose Company',
                                                ...
                                                },
                                                {
                                                    xtype: 'organization.combo',
                                                    label: 'Sub agent',
                                                    testId: 'inquiryCreateAppointmentSubAgentField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                ...
                                                },
                                                {
                                                    xtype: 'textfield',
                                                    label: 'Hub reference',
                                                    testId: 'inquiryCreateAppointmentHubReferenceField',
                                                    labelAlign: 'left',
                                                    ui: 'classic hovered-border',
                                                    cls: 'a-field-icon icon-short icon-rounded',
                                                    clearable: false,
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    scrollable: false,
                                                    itemId: 'createCargo',
                                                    testId: 'inquiryCreateAppointmentCargoFormList',
                                                                ...
                                                                items: [
                                                                    {
                                                                        ...
                                                                        cls: 'a-field-icon icon-short icon-rounded',
                                                                        label: 'Quantity',
                                                                        testId: 'inquiryCreateAppointmentCargoQuantityField',
                                                                        bind: {
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        label: 'Commodity',
                                                                        testId: 'inquiryCreateAppointmentCargoCommodityField',
                                                                        required: true,
                                                                        clearable: true,
                                                                        valueField: 'id',
                                                                        displayField: 'name',
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        testId: 'inquiryCreateAppointmentCargoOperationField',
                                                                        required: true,
                                                ...
                                                },
                                                {
                                                    ...
                                                    margin: '8 0 8 32',
                                                    text: 'Cargo',
                                                    testId: 'inquiryCreateAppointmentAddCargoButton',
    ...
    bbar: {
        items: [
            {
                xtype: 'notes.notify',
                testId: 'inquiryCreateAppointmentNotesNotify',
                viewModel: {
                    data: {
                        editMode: true,
                    },
            ...
            },
            {
                ...
                text: 'Save',
                testId: 'inquiryCreateAppointmentSaveButton',
                bind: {
