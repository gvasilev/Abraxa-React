Ext.define('Abraxa.view.inquiry.inquiryDetails.ProformaAttachments', {
    extend: 'Ext.Container',
    xtype: 'proforma.attachments',
    controller: 'proforma-controller',
    hidden: true,
    flex: 1,
    bind: {
        hidden: '{inquiryMenu.selection.tab == "attachments" ? false : true}',
    },
    id: 'inquiry-attachments-container',
    zIndex: '200',
    layout: {
        type: 'vbox',
    },
    ...
    items: [
            ...
            items: [
                {
                    ...
                    reference: 'companyDocuments',
                    bind: {
                        store: '{object_record.attachments}',
                    },
                    emptyText: {
                        xtype: 'container',
                        zIndex: 999,
        ...
        },
        {
            ...
            margin: '16',
            bind: {
                hidden: '{object_record.attachments.count ? false:true}',
            },
            layout: {
                type: 'hbox',
                align: 'middle',
