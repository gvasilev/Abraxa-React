        ...
        focus: function (combo) {
            ...
            Ext.Ajax.request({
                ...
                success: function (response) {
                    ...
                    const record = combo.up().ownerCmp.getRecord();
                    const vm = Ext.ComponentQuery.query('disbursement\\.items\\.grid')[0].upVM();
                    const selectedAccount = vm.get('selectedAccount');

                    if (selectedAccount && selectedAccount.get('custom_cost_center')) {
                        const customerCostCenter = selectedAccount.get('custom_cost_center');
                        sharedCostCenters = sharedCostCenters.filter((el) => el.id === customerCostCenter);
                    }
