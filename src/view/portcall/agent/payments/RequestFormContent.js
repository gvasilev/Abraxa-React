Ext.define('Abraxa.view.portlog.payment.RequestFormContent', {
    ...
    items: [
        {
            ...
            listeners: {
                painted: function (me) {
                    me.setValue(me.upVM().get('payment.org_id'));
                    me.setInputValue(me.upVM().get('payment.org_name'));
                },
