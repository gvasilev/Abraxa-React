...
Ext.define('Abraxa.view.portcall.disbursements.DisbursementItemsGrid', {
    ...
    columns: [
        ...
        },
        {
            ...
            summaryRenderer: 'emptySummaryRenderer',
            renderer: 'disbursementValueRender',
        },
        {
            text: 'Vendor',
            width: 180,
        ...
        },
        {
            ...
            summaryRenderer: 'cellAmountRenderer',
            exportSummaryRenderer: 'summaryCellAmountRenderer',
        },
        {
        ...
        },
        {
            ...
            cell: {
                ...
                formatter: 'number("0,000.00")',
                bind: {
                    cls: 'a-cell-amount a-final-da-cell a-br-100 {disbursementInvoices.count && selectedDisbursement.type != "pda" ? "hide_cell_content" : ""}',
                },
            },
            editor: {
                field: {
            ...
            summaryRenderer: 'emptySummaryRenderer',
            exportSummaryRenderer: 'emptySummaryRenderer',
            exportStyle: {
                alignment: {
                    horizontal: 'Right',
                },
        ...
        },
        {
            ...
            cell: {
                align: 'center',
                bind: {
                    cls: '{disbursementInvoices.count ? "hide_cell_content before_centered" : ""}',
                },
            },
            editor: {
                field: {
        ...
        },
        {
            ...
            cell: {
                encodeHtml: false,
                bind: {
                    cls: 'a-cell-bl {disbursementInvoices.count ? "hide_cell_content before_centered" : ""}',
                },
            },
            editor: {
                field: {
        ...
        },
        {
            ...
            cell: {
                encodeHtml: false,
                align: 'right',
                zeroValue: AbraxaConstants.placeholders.emptySpanWithDoubleZero,
        ...
        },
        {
            ...
            cell: {
                ...
                cls: 'a-cell-bl',
                align: 'center',
                zeroValue: AbraxaConstants.placeholders.emptySpanWithZeroValue,
            },
            editor: {
                field: {
                    ui: 'classic',
        ...
        },
        {
            ...
            exportSummaryRenderer: 'cellAmountRenderer',
            exportStyle: {
                alignment: {
                    horizontal: 'Center',
                },
        ...
        },
        {
            ...
            zeroValue: AbraxaConstants.placeholders.emptySpanWithZeroPercentage,
            editor: {
                field: {
                    ui: 'classic',
                    placeholder: '0%',
        ...
        },
        {
            ...
            summaryRenderer: 'varianceRenderer',
            exportSummaryRenderer: 'varianceSummaryRenderer',
            exportRenderer: 'varianceExportRenderer',
            cell: {
                encodeHtml: false,
                cls: 'a-br-100',
            },
