    ...
    columns: [
        ...
        },
        {
            ...
            editor: {
                ...
                listeners: {
                    complete: 'completeVoucherGridEdit',
                },
            },
            renderer: function (value, record) {
                if (value) {
                ...
                listeners: {
                    complete: function (editor, value) {
                        let gridRecord = editor.ownerCmp.getRecord(),
                            ...
                            invoices = editor.upVM().get('disbursementInvoices');
        ...
        },
        {
            ...
            cell: {
                ...
                cls: 'a-br-100',
                align: 'center',
                zeroValue: AbraxaConstants.placeholders.emptySpan,
            },
            renderer: function (value) {
                if (!value) {
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                const voucher = this.getParent().ownerCmp.getRecord();
                                if (voucher) {
                                    Ext.Msg.confirm(
                                        'Delete',
