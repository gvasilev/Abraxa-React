...
Ext.define('Abraxa.view.portcall.principal.PortcallViewModelPrincipal', {
    ...
    formulas: {
        portCallRecord: {
            bind: {
                bindTo: '{portcallMainViewPrincipal.record}',
            },
            get: function (record) {
                return record;
            },
            ...
            get: function (rec) {
                if (rec) {
                    var mainVM = Ext.getCmp('main-viewport').getVM(),
                        ...
                        portCallRecord = this.get('portCallRecord'),
                        recentExists = null;

                    recentlyOpened.add({
                        object_id: 3,
                        object_meta_id: portCallRecord.get('id'),
                        hash: mainVM.get('routeHash') + '/' + portCallRecord.get('id'),
                        watching: null,
                    });
