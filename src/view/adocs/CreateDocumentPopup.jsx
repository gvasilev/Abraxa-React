            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function(btn) {
                        ...
                        const expensesStore = currentViewModel.get('expenses');
                        ...
                        let docForm = Ext.create('Abraxa.view.adocs.InvoiceDocumentForm', {
                            viewModel: {
                                data: {
                                    object_record: currentViewModel.get('object_record'),
                                    organizations: currentViewModel.get('organizations'),
                                    documentTypes: currentViewModel.get('documentTypes'),
                                    document_data: {},
                                    subObjects: currentViewModel.get('subObjects'),
                                    fromSuply: false,
                                    currentUser: currentViewModel.get('currentUser'),
                                    expenses: expensesStore,
                                    recieptExpenses: currentViewModel.get('recieptExpenses'),
                                    accounts: currentViewModel.get('accounts'),
                                    vouchers: currentViewModel.get('vouchers'),
                                    bankAccounts: currentViewModel.get('bankAccounts'),
                                },
                                formulas: {
                                    expenseItems: {
                                        bind: {
                                        ...
                                        get: function(billingParty) {
                                            ...
                                            const expenses = currentVM.get('expenses'),
                                                expense = currentVM.get('expense'),
                                                data = [];
                        ...
                        let selectedType = currentViewModel.get('documentTypes').queryBy((rec, id) => {
