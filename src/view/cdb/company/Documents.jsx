import './UploadController.jsx';
import './DocumentsFileInfo.jsx';
Ext.define('Abraxa.view.cdb.company.Documents', {
        ...
        },
        {
            ...
            items: [
                                                    ...
                                                    click: {
                                                        ...
                                                        fn: function fn(element, htmlEl, c) {
                                                            ...
                                                            vm.get('documents').each(function (attachment) {
                                                                ...
                                                                attachment.getDocument().set('hide_status', true);
                                                                attachment.getDocument().set('not_in_portcall', true);
                ...
                },
                {
                    ...
                    margin: '16',
                    bind: {
                        hidden: '{documents.count ? false : true}',
                    },
                    layout: {
                        type: 'hbox',
                        align: 'middle',
