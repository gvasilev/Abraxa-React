Ext.define('Abraxa.view.operations.PortCallsPricipal.grids.PortCallsPricipalGridInPort', {
    extend: 'Ext.grid.Grid',
    xtype: 'PortCallsPricipalGridInport',
    itemId: 'PortCallsPricipalGridInport',
    layout: 'fit',
    cls: 'abraxa-grid',
    ui: 'bordered',
    scrollable: true,
    ...
    stateId: 'portcalls-grid-principal-in-port',
    bind: {
    ...
    columns: [
...

        {
            ...
            flex: 1,
            cell: {
                tpl: '<div class="a-val-xs"><div class="a-badge-sof sof-{latest_event_category}">{latest_event.name}</div></div>',
                encodeHtml: false,
            },
            exportRenderer: function (val, record) {
                if (
                    record.get(AbraxaConstants.labels.latestEvent) &&
                    record.get(AbraxaConstants.labels.latestEvent).name
                ) {
                    return record.get(AbraxaConstants.labels.latestEvent).name;
                }
