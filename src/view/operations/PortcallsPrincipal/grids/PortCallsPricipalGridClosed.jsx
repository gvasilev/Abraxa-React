Ext.define('Abraxa.view.operations.PortCallsPricipal.grids.PortCallsPricipalGridClosed', {
    extend: 'Ext.grid.Grid',
    xtype: 'PortCallsPricipalGridClosed',
    itemId: 'PortCallsPricipalGridClosed',
    layout: 'fit',
    cls: 'abraxa-grid',
    ui: 'bordered',
    scrollable: true,
    ...
    stateId: 'portcalls-grid-principal-closed',
    bind: {
