Ext.define('Abraxa.view.operations.PortCallsPricipal.grids.PortCallsPricipalGridSailed', {
    extend: 'Ext.grid.Grid',
    xtype: 'PortCallsPricipalGridSailed',
    itemId: 'PortCallsPricipalGridSailed',
    layout: 'fit',
    cls: 'abraxa-grid',
    ui: 'bordered',
    scrollable: true,
    ...
    stateId: 'portcalls-grid-principal-sailed',
    bind: {
    ...
    columns: [
        ...
        },
        {
            ...
            flex: 1,
            cell: {
                tpl: '<tpl if="vessel && vessel.name"><div data-vessel-id="{id}" class="a-val-link-xl">{vessel.name}</div> <tpl else><div>---</div></tpl>',
                encodeHtml: false,
                listeners: {
                    click: {
                        element: 'element',
            ...
            cell: {
                tpl: new Ext.XTemplate('{[this.renderPortCallDate(values.port_atd)]}', {
                    renderPortCallDate: function (portcallDate) {
                        if (portcallDate) {
                            return Abraxa.utils.Functions.renderPortcallDate(portcallDate);
                        }
        ...
        },
        {
            ...
            cell: {
                tpl: '<tpl if="port_stay"><div class="a-val" class="a-val-link">{port_stay}</div><tpl else><span class="a-cell-placeholder">---</span></tpl>',
        ...
        },
        {
            ...
            cell: {
                tpl: [
                    '<tpl if="next_port"><div data-port-id="{next_port_id}" class="a-val-link">{next_port}</div><tpl else><span class="a-cell-placeholder">---</span></tpl>',
                ],
                encodeHtml: false,
                listeners: {
                    click: {
        ...
        },
        {
            ...
            cell: {
                tpl: [
                    '<tpl if="next_port_eta"><div class="a-val">{next_port_eta:date("d M - H:m")}</div><tpl else><span class="a-cell-placeholder">---</span></tpl>',
                ],
                encodeHtml: false,
            },
        },
