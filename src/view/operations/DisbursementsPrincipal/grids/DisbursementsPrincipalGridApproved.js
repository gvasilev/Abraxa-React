Ext.define('Abraxa.view.operations.DisbursementsPrincipal.grids.DisbursementsPrincipalGridApproved', {
    extend: 'Ext.grid.Grid',
    xtype: 'DisbursementsPrincipalGridApproved',
    itemId: 'disbursementsPrincipalGridApproved',
    layout: 'fit',
    ...
    stateId: 'disbursement-grid-principal-approved',
    bind: {
