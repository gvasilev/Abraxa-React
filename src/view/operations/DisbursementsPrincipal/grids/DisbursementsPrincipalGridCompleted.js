Ext.define('Abraxa.view.operations.DisbursementsPrincipal.grids.DisbursementsPrincipalGridCompleted', {
    extend: 'Ext.grid.Grid',
    xtype: 'DisbursementsPrincipalGridCompleted',
    itemId: 'disbursementsPrincipalGridCompleted',
    layout: 'fit',
    ...
    stateId: 'disbursement-grid-principal-completed',
    bind: {
