Ext.define('Abraxa.view.operations.DisbursementsPrincipal.grids.DisbursementsPrincipalGridAwaitingApproval', {
    extend: 'Ext.grid.Grid',
    xtype: 'DisbursementsPrincipalGridAwaitingapproval',
    itemId: 'disbursementsPrincipalGridAwaitingapproval',
    layout: 'fit',
    ...
    stateId: 'disbursement-grid-principal-awaiting-approval',
    bind: {
                ...
                tools: [
                    {
                        ...
                        // handler: 'redirectToDisbursement'
                    },
                ],
            },
        },
